...
def get_user_list(config, key):
    with open('{}/ThedakkidaikkathavalBot/{}'.format(os.getcwd(), config),
              'r') as json_file:
...
class Config(object):
    ...
    OWNER_ID = 1281282633 # If you dont know, run the bot and do /id in your private chat with it, also an integer
    OWNER_USERNAME = "rajeshrakis"
    SUPPORT_CHAT = 'rakis_support'  #Your own group for support, do not add the @
