...
import ThedakkidaikkathavalBot.modules.sql.global_bans_sql as gban_sql
import ThedakkidaikkathavalBot.modules.sql.users_sql as user_sql
from ThedakkidaikkathavalBot import DEV_USERS, OWNER_ID, dispatcher
