...
from ThedakkidaikkathavalBot import (DEV_USERS, OWNER_ID, DRAGONS, DEMONS, TIGERS, WOLVES,
                          INFOPIC, dispatcher, sw)
from ThedakkidaikkathavalBot.__main__ import STATS, TOKEN, USER_INFO
import ThedakkidaikkathavalBot.modules.sql.userinfo_sql as sql
from ThedakkidaikkathavalBot.modules.disable import DisableAbleCommandHandler
from ThedakkidaikkathavalBot.modules.sql.global_bans_sql import is_user_gbanned
from ThedakkidaikkathavalBot.modules.sql.afk_sql import is_afk, check_afk_status
from ThedakkidaikkathavalBot.modules.sql.users_sql import get_user_num_chats
from ThedakkidaikkathavalBot.modules.helper_funcs.chat_status import sudo_plus
from ThedakkidaikkathavalBot.modules.helper_funcs.extraction import extract_user
from ThedakkidaikkathavalBot import telethn as SaitamaTelethonClient, TIGERS, DRAGONS, DEMONS
